...
import kotlinx.android.synthetic.main.activity_register_second_part.*
import java.util.*

class RegisterSecondPart : AppCompatActivity(), DatePickerDialog.OnDateSetListener, AdapterView.OnItemSelectedListener  {
    var dia =0
    var mes = 0
    var anio = 0
    var diaGuardado = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_register_second_part)
        val fechaEditText = findViewById<EditText>(R.id.fecha)


        pickDate()

        var opcion = arrayOf(getString(R.string.pais),getString(R.string.Colombia), getString(R.string.EstadosUnidos), getString(
            R.string.Mexico), getString(R.string.Brasil))
    ...
    override fun onNothingSelected(parent: AdapterView<*>?) {
        Toast.makeText(applicationContext, getString(R.string.pais), Toast.LENGTH_LONG).show()
    }
